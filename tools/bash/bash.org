...
=POSIX= Una familia de estándares de  sistemas abiertos basados en Unix. Bash se
ocupa  principalmente de  la  parte de  Shell y  Utilidades  del estándar  POSIX
1003.1.

=blank= Un espacio o carácter de tabulación.

=builtin= Un  comando que es implementado  internamente por el propio  shell, en
lugar de por un programa ejecutable en algún lugar del sistema de archivos.

=control operator=  Un token que  realiza una función  de control. Es  una nueva
línea o uno  de los siguientes: ='||',  '&&', '&', ';', ';;',  ';&', ';;&', '|',
'|&', '(', o ')'=.
